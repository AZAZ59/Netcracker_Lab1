...
import NC_Lab1.controller.Controller;
...
public class View {
    ...
    private void show_dialog_Find_Genre() {
        ...
        switch (scan.nextInt()) {
            case 1:
                ...
                ctrl.find_genre(1, scan.next());
                break;
            case 2:
                System.out.print("Введите название жанра: ");
                ctrl.find_genre(2, scan.next());
                break;
            case 3:
                ctrl.find_genre(3, null);
                break;
            case 0:
                show_dialog_Find();
                break;
    ...
    public void query_results_tracks(ArrayList<String> strings) {
        System.out.println("Название трека \tИсполнитель \tАльбом \tПродолжительность трека \tЖанр");
    ...
    public void show_dialog_save() {
        ...
        switch (scan.nextInt()) {
            case 1:
                ...
                ctrl.save(1, scan.next());
                break;
            case 2:
                System.out.print("Введите название файла: ");
                ctrl.save(2, scan.next());
                break;
            case 0:
                show_dialog_start();
                break;
